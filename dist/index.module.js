...
/** @class */
function (_super) {
  __extends(SubdisciplinaComponent, _super);
  ...
  SubdisciplinaComponent = __decorate([Component({
    components: {
      'nested-select': NestedSelectComponent
    },
    computed: {
...
/** @class */
function (_super) {
  __extends(AreaConocimientoCrudComponent, _super);
  ...
  AreaConocimientoCrudComponent = __decorate([Component({
    components: {
      'b-modal': bModal,
      'nested-select': NestedSelectComponent,
...
export { AreaConocimientoComponent$1 as AreaConocimientoComponent, AreaConocimientoCrudComponent$1 as AreaConocimientoCrudComponent, CampoComponent$1 as CampoComponent, CatalogoComponent$1 as CatalogoComponent, DisciplinaComponent$1 as DisciplinaComponent, SubdisciplinaComponent$1 as SubdisciplinaComponent };
